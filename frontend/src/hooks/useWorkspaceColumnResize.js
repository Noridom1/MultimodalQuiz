...
const DEFAULTS = { left: 300 };
/** Minimum width reserved for the quiz column when resizing the sources column. */
const MIN_RIGHT = 260;
const LIMITS = { left: [220, 520], resizer: 8 };
